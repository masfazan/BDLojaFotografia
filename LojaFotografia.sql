...
--Tabela Endereço 
create table Endereco (CodEnd int not null,
...
create table ClientePessoaFisica (CodClientePF int not null,
...
create table ClientePessoaJuridica (CodClientePJ int not null,
...
--Tabela Funcionário
create table Funcionario (CodFunc int not null,
...
--Tabela Produto
create table Produto (CodProd int not null,
...
--Tabela Venda
create table Venda (NumVenda int not null,
...
--foreign key fkItemVenda (ItemVendaID) references ItemVenda(NumVenda)?
);
--Tabela Item Venda
create table ItemVenda (NumItemVenda int not null,
CodProdIV int,
...
insert to ItemVenda (NumItemVenda, CodProdIV, Quantidade, TotalItem)
values (1, 1, 1, 11.50)
insert into Venda (NumVenda, DataVenda,ValorVenda,CondPagamento,CodVFunc, CodVClientePF,CodVClientePJ)
